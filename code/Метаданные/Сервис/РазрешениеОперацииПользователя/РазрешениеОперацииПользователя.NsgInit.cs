...
namespace Авто.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataEnum", Guid = "b75cffbb-2128-4ed3-9f6f-ea23f38f2363")]
	...
	Разрешено.GroupName = "";
	Разрешено.Guid = NsgService.StringToGuid("3d8e68f8-433b-4e9b-8d86-d92ec2518900");
	...
	Запрещено.GroupName = "";
	Запрещено.Guid = NsgService.StringToGuid("9e5a62da-2c98-41db-b29c-ee97c506d034");
	...
	Наследует.GroupName = "";
	Наследует.Guid = NsgService.StringToGuid("ddde035e-6e7b-421d-ac8b-441bdab30552");
	...
	Visible = false;
	Guid = NsgService.StringToGuid("b75cffbb-2128-4ed3-9f6f-ea23f38f2363");
	DefaultSortingName = "";
	...
	GroupName = "Сервис";
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("b75cffbb-2128-4ed3-9f6f-ea23f38f2363"));
            if (obj == null)
