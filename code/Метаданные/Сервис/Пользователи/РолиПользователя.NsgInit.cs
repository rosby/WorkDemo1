...
namespace Авто.Метаданные._SystemTables
{
    ...
    [NsgTypeName("NsgDataTable", Guid = "5dc91748-0066-4111-8bd2-91a6631f4250")]
    public partial class РолиПользователя : NsgSoft.DataObjects.NsgDataTable
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("5dc91748-0066-4111-8bd2-91a6631f4250"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("894c8752-5f10-4ccc-9102-3823ea2baac4");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("a7f0d131-3edd-4c3e-8a5a-600bbacf7965");
	...
	Владелец.GroupName = "";
	Владелец.Guid = NsgService.StringToGuid("f1bb020b-1237-4b3d-87d8-58d383845952");
	...
	НомерСтроки.Guid = NsgService.StringToGuid("e28d6316-57ca-4175-a8be-cf235b3721a6");
	...
	РольПользователя.Guid = NsgService.StringToGuid("cba3ff03-3aa2-4ab6-b126-ed66b2228e5d");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("5dc91748-0066-4111-8bd2-91a6631f4250");
	DefaultSortingName = "";
