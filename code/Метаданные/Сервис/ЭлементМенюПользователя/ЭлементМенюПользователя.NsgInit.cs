...
namespace Авто.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "75143989-cbb8-40ee-ad08-4c2ebc6d4c85")]
    public partial class ЭлементМенюПользователя : NsgSoft.DataObjects.NsgDataDictionary
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("75143989-cbb8-40ee-ad08-4c2ebc6d4c85"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("c61bba6e-126e-480f-aa92-dabd78b14904");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("3023c676-7601-40b1-b460-ff7bca84db2d");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("d2273ea8-b4cf-4312-a2b2-2c7985364261");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("4c343bf4-2def-4ae7-94c3-48ce9e0f7477");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("5a162fa8-9690-401a-b7b7-274af690ed17");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("63d26a97-3218-4bcb-8b77-e9bda4244406");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("96327912-9683-4e99-93ae-78f8e84c9b77");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("e8e43647-7e55-4f10-b58a-e5463393a94c");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("e39802bf-d05f-41da-8e75-c3538f617f6c");
	...
	Наименование.Guid = NsgService.StringToGuid("86ac7950-bd4a-4e47-9819-c5f888c9c511");
	...
	ОбъектМетаданных.Guid = NsgService.StringToGuid("b66ae369-75cb-46ea-922e-59a30a8c7bf8");
	...
	Картинка.GroupName = "";
	Картинка.Guid = NsgService.StringToGuid("3d41408f-749a-4d21-9295-c619c2e58487");
	...
	БольшаяИконка.Guid = NsgService.StringToGuid("faf119b1-a7cd-4e03-bf3f-90d32d225690");
	...
	Таблица.GroupName = "";
	Таблица.Guid = NsgService.StringToGuid("eba6ba2d-952d-4c89-96ad-d794a438f487");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("75143989-cbb8-40ee-ad08-4c2ebc6d4c85");
	DefaultSortingName = "";
