...
namespace Авто.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataTable", Guid = "aef369c1-26e8-4acf-982c-1420efd8d775")]
    public partial class ТаблицаЭлементаМенюПользователя : NsgSoft.DataObjects.NsgDataTable
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("aef369c1-26e8-4acf-982c-1420efd8d775"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("0a38d807-6916-4c2e-8292-19e36d4564f1");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("c2f28b9e-ac19-4430-b2cc-6003d66f4a15");
	...
	Владелец.GroupName = "";
	Владелец.Guid = NsgService.StringToGuid("f746d447-30db-4aa5-b761-dfe2831db870");
	...
	НомерСтроки.Guid = NsgService.StringToGuid("7b5b67dd-7c98-499e-a94d-e34066bf0204");
	...
	РольПользователя.Guid = NsgService.StringToGuid("c129e95a-101b-4626-9472-6efda71c5ce0");
	...
	Активность.Guid = NsgService.StringToGuid("6948cfd7-1aec-4a06-ae7c-0cef2aa516b3");
	...
	Открыть.GroupName = "";
	Открыть.Guid = NsgService.StringToGuid("72aaf975-69c6-4c60-97d1-5971d3b8eaf8");
	...
	СоздатьНовый.Guid = NsgService.StringToGuid("8799f4fd-58ef-4b41-a40f-5ff170242c25");
	...
	Visible = false;
	Guid = NsgService.StringToGuid("aef369c1-26e8-4acf-982c-1420efd8d775");
	DefaultSortingName = "";
