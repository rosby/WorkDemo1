...
namespace Авто.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataEnum", Guid = "d94c6be0-d89d-40e8-8a94-67fdf80c73c1")]
	...
	Оповещение.Guid = NsgService.StringToGuid("382ceac0-89f3-489c-977b-1e7da6596a90");
	...
	Предупреждение.Guid = NsgService.StringToGuid("edec493a-81f9-492e-9caa-d1c16fd72798");
	...
	Напоминание.Guid = NsgService.StringToGuid("bd56ba36-c6e9-4eb9-8014-c4d3997e2ece");
	...
	Name = "ТипСообщения";
	Visible = true;
	Guid = NsgService.StringToGuid("d94c6be0-d89d-40e8-8a94-67fdf80c73c1");
	DefaultSortingName = "";
	...
	GroupName = "Сервис";
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("d94c6be0-d89d-40e8-8a94-67fdf80c73c1"));
            if (obj == null)
