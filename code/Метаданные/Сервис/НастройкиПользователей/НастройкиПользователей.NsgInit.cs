...
namespace Авто.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataTable", Guid = "2ae498a7-26fc-426f-824d-375b8f9b052e")]
    public partial class НастройкиПользователей : NsgSoft.DataObjects.NsgDataTable
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("2ae498a7-26fc-426f-824d-375b8f9b052e"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("a8639afa-b73c-4a79-bbdd-5e047f51e98a");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("af432058-2475-499b-b95c-33238f371670");
	...
	Владелец.GroupName = "";
	Владелец.Guid = NsgService.StringToGuid("e6b77a7d-470d-459c-ae43-1889c6487152");
	...
	НомерСтроки.Guid = NsgService.StringToGuid("c6b53fcc-5098-43fb-a74c-2b4700fafbfc");
	...
	ИдентификаторОбъекта.Guid = NsgService.StringToGuid("d52beecf-b2e9-4ff2-a4c4-958cee586896");
	...
	ОбъектМетаданных.Guid = NsgService.StringToGuid("dbae8ab6-b145-437f-a4bc-ab56e5efaac3");
	...
	Наименование.Guid = NsgService.StringToGuid("55aab64d-d538-4cc7-9547-1d2f2224db6f");
	...
	XmlText.GroupName = "";
	XmlText.Guid = NsgService.StringToGuid("9bd0c845-2f38-4937-9a28-4d457a22055d");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("2ae498a7-26fc-426f-824d-375b8f9b052e");
	DefaultSortingName = "";
