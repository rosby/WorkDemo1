...
namespace Авто.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "8da2ea06-e8ef-46b3-a24a-dd3ed9a8303d")]
    public partial class ТипыОбмена : NsgSoft.DataObjects.NsgDataDictionary
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("8da2ea06-e8ef-46b3-a24a-dd3ed9a8303d"));
            if (obj == null)
                obj = new ТипыОбмена();
	...
	Идентификатор.Guid = NsgService.StringToGuid("eab8c620-429b-44e4-aeb8-2f15150f7ca2");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("125f9201-9a9d-447f-8afa-b89482ced879");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("150642cb-d561-4b57-af6b-f8afc5a99b98");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("7a82f070-e2c5-4f14-8796-5ecf2b4372f2");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("ea755dde-fb94-4bb5-82f7-f4e12ffb5f20");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("59d721f7-7b44-4633-a007-cda5509825fb");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("107a68c3-830d-4794-910b-1dc84ff35008");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("7639a46a-0c31-4f58-9120-e4863498ce33");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("382d2ce6-c643-4af8-b597-8a5245dd2b6a");
	...
	Наименование.Guid = NsgService.StringToGuid("faff4a1c-5660-4a69-91fb-2a637175e440");
	...
	Файл.Guid = NsgService.StringToGuid("8d9f64c4-3f20-4c14-aa15-b0383daa55de");
	...
	Email.Guid = NsgService.StringToGuid("437545c5-7c4a-44c9-8694-4fa26e6e712c");
	...
	SQL.Guid = NsgService.StringToGuid("4848fb78-a8bb-4b08-9ceb-2b4490ac11b4");
	...
	Name = "ТипыОбмена";
	Visible = true;
	Guid = NsgService.StringToGuid("8da2ea06-e8ef-46b3-a24a-dd3ed9a8303d");
	DefaultSortingName = "";
	...
	GroupName = "Сервис";
        ...
        public static ТипыОбмена Файл
        {
            get
            {
                return (ТипыОбмена)getPredefined(NsgService.StringToGuid("8da2ea06-e8ef-46b3-a24a-dd3ed9a8303d"), NsgService.StringToGuid("8d9f64c4-3f20-4c14-aa15-b0383daa55de"));
            }
        }
        ...
        public static ТипыОбмена Email
        {
            get
            {
                return (ТипыОбмена)getPredefined(NsgService.StringToGuid("8da2ea06-e8ef-46b3-a24a-dd3ed9a8303d"), NsgService.StringToGuid("437545c5-7c4a-44c9-8694-4fa26e6e712c"));
            }
        }
        ...
        public static ТипыОбмена SQL
        {
            get
            {
                return (ТипыОбмена)getPredefined(NsgService.StringToGuid("8da2ea06-e8ef-46b3-a24a-dd3ed9a8303d"), NsgService.StringToGuid("4848fb78-a8bb-4b08-9ceb-2b4490ac11b4"));
            }
        }
