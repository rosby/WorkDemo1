...
namespace Авто.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgReportObject", Guid = "a28c9931-5806-4d29-b625-ec0e4b04682e")]
    public partial class ИмпортДанных : NsgSoft.DataObjects.NsgReportObject
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("a28c9931-5806-4d29-b625-ec0e4b04682e"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("4cf7fc2f-48d3-43b5-8c66-4691afe69696");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("ce32a597-63b3-499d-a39d-75aeb5c82a9d");
	...
	ФормаЭлемента.Guid = NsgService.StringToGuid("c98ba9f5-fc96-467e-af71-73badb88e4d6");
	...
	Name = "ИмпортДанных";
	Visible = true;
	Guid = NsgService.StringToGuid("a28c9931-5806-4d29-b625-ec0e4b04682e");
	DefaultSortingName = "";
