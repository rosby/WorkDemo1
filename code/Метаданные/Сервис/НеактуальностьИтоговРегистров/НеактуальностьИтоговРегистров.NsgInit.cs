...
namespace Авто.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "6b67c042-8328-44db-b09b-e5b5f9209367")]
    public partial class НеактуальностьИтоговРегистров : NsgSoft.DataObjects.NsgDataDictionary
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("6b67c042-8328-44db-b09b-e5b5f9209367"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("6832645d-2071-42ce-8a3b-d713f3b6e82b");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("72fe6411-7b36-45f6-894f-e94aee252e9b");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("fa98436d-f68e-4f07-9175-b4260ab73cb4");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("227519bf-f7bf-4bf3-96db-d5ed7065c0cb");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("82347d87-b844-4ee3-8485-0fdaf2e5ff49");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("14f8ef0f-9d3c-4a86-84e9-1fdd7b1dbcf2");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("4b659c40-0688-4053-b10c-7470896488b1");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("61283160-14f3-4dd7-9ed2-3a8be8bb2e8f");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("4281b142-b69a-4ae1-902e-623171679fb0");
	...
	ИдентификаторОбъекта.Guid = NsgService.StringToGuid("bcbd89dd-1f51-469a-9b41-2ce57d68ccf0");
	...
	ВладелецДвижения.Guid = NsgService.StringToGuid("1560dfe5-17b6-432c-8c06-563a477a1335");
	...
	ДатаДокумента.Guid = NsgService.StringToGuid("69f741a5-a88d-400b-880d-0596c060fb23");
	...
	ФормаСписка.Guid = NsgService.StringToGuid("bcfd25ea-4f4a-4843-9bc3-bcf2bee92f76");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("6b67c042-8328-44db-b09b-e5b5f9209367");
	DefaultSortingName = "";
