...
namespace Авто.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataRegistrationJournal", Guid = "b9f1fc16-ec79-4f44-a9d8-cd8e90028281")]
    public partial class ДействияПользователей : NsgSoft.DataObjects.NsgDataRegistrationJournal
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("b9f1fc16-ec79-4f44-a9d8-cd8e90028281"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("06e95a52-845b-4431-a7ca-829ab6087431");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("9ab3cd13-f6ac-4ccb-b50e-811aa43bff25");
	...
	ДатаВремя.GroupName = "";
	ДатаВремя.Guid = NsgService.StringToGuid("e15f4dd1-e643-4aed-84d4-f59fb32317ae");
	...
	Пользователь.Guid = NsgService.StringToGuid("45a3bbe7-fecc-4fe4-a78d-394ee71f4d7e");
	...
	ИдентификаторПользователя.Guid = NsgService.StringToGuid("2dd02e8d-0283-4668-95e6-257f05d90d71");
	...
	СистемныйПользователь.Guid = NsgService.StringToGuid("ff8adfee-e76a-48cb-bd37-91b9dffc3a58");
	...
	Компьютер.GroupName = "";
	Компьютер.Guid = NsgService.StringToGuid("ca9c795b-9748-4a97-9f12-09201e59d1f3");
	...
	Событие.GroupName = "";
	Событие.Guid = NsgService.StringToGuid("6927b645-c4ad-4f40-97ba-cd17ede09636");
	...
	Комментарий.Guid = NsgService.StringToGuid("238a9055-270b-402f-bdb6-6fcb3f12d3b6");
	...
	ИдентификаторОбъекта.Guid = NsgService.StringToGuid("849c7af4-0b5b-458c-a0f4-02cdd1f3f1dc");
	...
	ПолноеИмяОбъекта.Guid = NsgService.StringToGuid("583f2618-2cec-4b5e-9720-2d116f31cc97");
	...
	ГруппаОбъекта.Guid = NsgService.StringToGuid("480c085d-57a1-483c-afe7-fa5179a659ca");
	...
	ПредставлениеОбъекта.Guid = NsgService.StringToGuid("91d69a6c-3215-472b-b47a-a0f055d8c8ec");
	...
	Данные.GroupName = "";
	Данные.Guid = NsgService.StringToGuid("73957a2d-4f6e-4c3b-9731-0e0660f03e8b");
	...
	ФормаСписка.Guid = NsgService.StringToGuid("5b8bad00-65d9-4d15-b0f0-010d0bbdc3b8");
	...
	ФормаЭлемента.Guid = NsgService.StringToGuid("fa74462c-6b57-4a79-b9d4-4ca6b5cba9ab");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("b9f1fc16-ec79-4f44-a9d8-cd8e90028281");
	DefaultSortingName = "";
