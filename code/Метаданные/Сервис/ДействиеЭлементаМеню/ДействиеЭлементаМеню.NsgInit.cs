...
namespace Авто.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataEnum", Guid = "fab8451a-c88c-47a0-8d34-8ed2ffc90138")]
	...
	Открыть.GroupName = "";
	Открыть.Guid = NsgService.StringToGuid("aa3bc09c-37c9-45a4-9e64-c7c0500ec04d");
	...
	СоздатьНовый.Guid = NsgService.StringToGuid("03fbbe70-974c-4731-99ef-35518bd36d74");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("fab8451a-c88c-47a0-8d34-8ed2ffc90138");
	DefaultSortingName = "";
	...
	GroupName = "Сервис";
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("fab8451a-c88c-47a0-8d34-8ed2ffc90138"));
            if (obj == null)
