...
namespace Авто.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "b06f0ddb-9a2b-4201-bcaa-9cce29f610ae")]
    public partial class СписокСообщений : NsgSoft.DataObjects.NsgDataDictionary
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("b06f0ddb-9a2b-4201-bcaa-9cce29f610ae"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("42163701-6302-43cf-8903-d52c42ea6501");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("7e059f7f-e9a3-4c76-830a-4ddeb11d6481");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("03483182-5de5-4d45-bbc3-30ad51ebd1dd");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("9500fc91-fd6e-4502-a6dd-b6530e7dbd23");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("2edbc404-3a13-4188-9902-b4525d3a0eb3");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("b2a330f4-2b57-4e0d-8b3f-f0a0d012e0d0");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("9e4e7e79-4e34-4b2f-94e3-0971addfcdd4");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("f802fb56-1c6f-46e8-b6ef-a226e5f65f2c");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("60b96bd7-631e-4e59-9dd3-7deb1d59865c");
	...
	ТипСообщения.Guid = NsgService.StringToGuid("68005209-4741-4736-9160-0bec9cab0eef");
	...
	ТекстСообщения.Guid = NsgService.StringToGuid("646bf141-468d-4be5-8558-f8e3caa5439c");
	...
	ОбъектСообщения.Guid = NsgService.StringToGuid("e8453ba6-1953-471a-876f-71be2b552109");
	...
	АдресатСообщения.Guid = NsgService.StringToGuid("0dfa73a8-3b3f-4197-85fd-f5c94a0096ff");
	...
	АктуальностьСообщения.Guid = NsgService.StringToGuid("26f7e08c-dc05-484c-a8c2-26991d950011");
	...
	ВремяПоявленияСообщения.Guid = NsgService.StringToGuid("37691837-c1c2-437a-b989-681a97a0529b");
	...
	СтатусСообщения.Guid = NsgService.StringToGuid("2609cd53-0e45-40be-8b00-a22ca009e47a");
	...
	АвторСообщения.Guid = NsgService.StringToGuid("2a1cbaed-2457-4e00-8104-dd2db9493365");
	...
	ФормаСписка.Guid = NsgService.StringToGuid("17006a83-e0ba-46ff-bda7-257d8b8c01b8");
	...
	ФормаЭлемента.Guid = NsgService.StringToGuid("6ed2848a-9413-47bc-a8b8-40dc064dbf46");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("b06f0ddb-9a2b-4201-bcaa-9cce29f610ae");
	DefaultSortingName = "";
