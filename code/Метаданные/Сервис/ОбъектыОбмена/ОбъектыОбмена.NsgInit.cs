...
namespace Авто.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "384c1914-0b3b-46a4-891d-56935cd490a7")]
    public partial class ОбъектыОбмена : NsgSoft.DataObjects.NsgDataDictionary
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("384c1914-0b3b-46a4-891d-56935cd490a7"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("776c0afd-6e50-4160-bd35-33fe4bc07260");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("49f2f4ee-90ab-4718-b2d4-fadd0f59a04f");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("9b9b46c2-bc98-4f5c-951b-e51eee1bcbee");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("0eed46fd-237a-4a4b-811c-a62cafcb0959");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("1c3253c5-9976-4125-9d8a-2015e3598039");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("68d8829d-c901-4844-a16d-8436576e8329");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("b024fa2e-fc7c-4d71-b9ad-bdba5ab1658e");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("ce2f9a66-65af-45a5-9b38-465c56dafa6d");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("1ecd26bc-0a22-48fc-a0b4-388f9791368c");
	...
	ОбъектОбмена.Guid = NsgService.StringToGuid("5401423b-b93a-4ca1-88bc-85113f3bdb0c");
	...
	БазаПолучатель.Guid = NsgService.StringToGuid("b5ec07a9-52f3-46d1-80fd-866b61c87111");
	...
	НомерОбмена.Guid = NsgService.StringToGuid("7694d7b4-90ec-416c-9dae-41e6818157ea");
	...
	Name = "ОбъектыОбмена";
	Visible = true;
	Guid = NsgService.StringToGuid("384c1914-0b3b-46a4-891d-56935cd490a7");
	DefaultSortingName = "";
