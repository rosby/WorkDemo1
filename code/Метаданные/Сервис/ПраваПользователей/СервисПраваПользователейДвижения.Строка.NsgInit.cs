...
{
    [NsgTypeName("NsgDataTableRow", Guid = "66f2b2bc-aeb9-4e83-9c57-38212ff80b73")]
    public partial class Строка : NsgSoft.DataObjects.NsgDataTableRow
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("66f2b2bc-aeb9-4e83-9c57-38212ff80b73"));
            if (obj == null)
                obj = new Строка();
