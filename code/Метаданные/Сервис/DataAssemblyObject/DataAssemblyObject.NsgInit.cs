...
namespace Авто.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataAssemblyObject", Guid = "3a981025-9615-43d3-ace9-81bbfa175da4")]
    public partial class DataAssemblyObject : NsgSoft.DataObjects.NsgDataAssemblyObject
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("3a981025-9615-43d3-ace9-81bbfa175da4"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("f0baff3a-7e16-478b-a2de-38bff9f583c3");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("30cd5fbc-d5a5-4f39-b1ca-03572accb097");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("36ee7fef-9093-4c5f-94d0-d26468bc52de");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("c5467bfb-397b-4c1d-8420-d6066009fd05");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("19979ac1-7a10-4339-a99e-55fda622a5a6");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("96bd1acb-70c5-49e1-ae2b-44c01d8daafd");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("d2bd6705-d17b-4980-8586-61f85f0f77e0");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("38479d98-9377-4164-b6c1-585e4057a7fa");
	...
	_AsmName.GroupName = "";
	_AsmName.Guid = NsgService.StringToGuid("d6202a72-31ab-4c9f-8188-daf357a28129");
	...
	_AsmVersion.Guid = NsgService.StringToGuid("68a9dc9d-f3e2-4ab3-acdc-0e29257be64f");
	...
	_AsmHash.GroupName = "";
	_AsmHash.Guid = NsgService.StringToGuid("63f983fd-d428-4464-bc08-52ad2d7c4f9d");
	...
	_AsmData.GroupName = "";
	_AsmData.Guid = NsgService.StringToGuid("7ebbd13c-5d0a-425d-98a7-d4057bf40672");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("4fe6ce87-d196-45bf-af8d-a7337a468d5c");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("3a981025-9615-43d3-ace9-81bbfa175da4");
	DefaultSortingName = "";
