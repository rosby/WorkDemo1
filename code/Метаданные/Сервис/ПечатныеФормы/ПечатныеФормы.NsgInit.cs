...
namespace Авто.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataCharacteristics", Guid = "6691ac18-bc8c-48e6-9b60-99d9ae05974b")]
    public partial class ПечатныеФормы : NsgSoft.DataObjects.NsgDataCharacteristics
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("6691ac18-bc8c-48e6-9b60-99d9ae05974b"));
            if (obj == null)
	...
	Дата.GroupName = "";
	Дата.Guid = NsgService.StringToGuid("1009e18b-88c5-4eec-966b-6617ec186e7b");
	...
	КонецПериода.Guid = NsgService.StringToGuid("e3bc6712-47c7-43d2-be20-5ac897d7ffc9");
	...
	Идентификатор.Guid = NsgService.StringToGuid("46f56493-8a6a-4a10-91c8-f9d5834e4102");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("86f17425-abaa-4b4a-ab67-34419701f408");
	...
	Движения.GroupName = "";
	Движения.Guid = NsgService.StringToGuid("771058cd-7176-4e76-b166-80813f0c7a8f");
	...
	Владелец.GroupName = "";
	Владелец.Guid = NsgService.StringToGuid("0f571c07-96d6-4c06-bca1-5fc45e4a8755");
	...
	ОбъектМетаданных.Guid = NsgService.StringToGuid("5d10b73b-d19f-464c-a997-a4e5fbfe72b0");
	...
	Обработка.GroupName = "";
	Обработка.Guid = NsgService.StringToGuid("13026c84-c7d8-4d82-a547-956a5a14c48d");
	...
	Наименование.Guid = NsgService.StringToGuid("501811bb-0dad-4b58-9c07-65d3fdcf8523");
	...
	ПечатнаяФорма.Guid = NsgService.StringToGuid("9b541d70-b663-43aa-988e-36afc3fe137e");
	...
	Условие.GroupName = "";
	Условие.Guid = NsgService.StringToGuid("639abd7b-377d-4f0a-9bcc-c54971e30f02");
	...
	ФормаСписка.Guid = NsgService.StringToGuid("23990e6b-6f13-4891-82e3-9f65661b4acd");
	...
	ФормаЭлемента.Guid = NsgService.StringToGuid("f7da7f14-2fbe-48be-9691-384791632e56");
	...
	Name = "ПечатныеФормы";
	Visible = true;
	Guid = NsgService.StringToGuid("6691ac18-bc8c-48e6-9b60-99d9ae05974b");
	DefaultSortingName = "";
