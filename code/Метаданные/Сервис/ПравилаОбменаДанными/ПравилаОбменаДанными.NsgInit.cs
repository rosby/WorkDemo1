...
namespace Авто.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "74151495-51fb-474c-82d4-8de158ee7075")]
    public partial class ПравилаОбменаДанными : NsgSoft.DataObjects.NsgDataDictionary
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("74151495-51fb-474c-82d4-8de158ee7075"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("38c84790-b577-44b6-b8b7-bd9442cbe2c5");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("7c7a376d-9acd-4d04-b5ef-b02b141e608c");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("02bda87e-1391-458f-8e03-64b98063fdba");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("05ecee29-6c23-40d2-ac8e-a3661b0e813e");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("2f1ad828-7d6d-4271-8b2f-7e2db090a7ef");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("054044df-bc1c-45a8-8c85-278de9feb85e");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("0678c7d6-cc79-4286-84d0-0e9ed79bbc10");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("448cf6f4-ffa3-4102-87d5-29782e9ae2bd");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("866c004c-b9dd-4d84-8d67-aa7be29a82cc");
	...
	ТипОбъектаОбмена.Guid = NsgService.StringToGuid("0616f98a-11e2-4f59-928e-30078d183f33");
	...
	ВыгрузкаЗависимыхОбъектов.Guid = NsgService.StringToGuid("71ccdf52-61b3-4b66-b6ae-5c624e3aebd9");
	...
	БазаИсточник.Guid = NsgService.StringToGuid("b7c3fe8d-9f92-4451-b12f-18f86ce987fb");
	...
	БазаПолучатель.Guid = NsgService.StringToGuid("dfa68b33-288b-4f3f-9015-8648deed2273");
	...
	ПроводитьВсеДокументы.Guid = NsgService.StringToGuid("4244212c-c276-41ff-8efe-e14e4aea635e");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("74151495-51fb-474c-82d4-8de158ee7075");
	DefaultSortingName = "";
