...
namespace Авто.Метаданные.Сервис
{
    ...
    [NsgTypeName("NsgDataEnum", Guid = "7a058b3c-05c6-4537-a7bb-5fd8848712ce")]
	...
	Создан.GroupName = "";
	Создан.Guid = NsgService.StringToGuid("71baea60-c0e9-4cb4-a25a-228d1abd9a9d");
	...
	Сохранен.GroupName = "";
	Сохранен.Guid = NsgService.StringToGuid("8569369b-4047-4fd3-bbff-1907a7175b94");
	...
	Удален.GroupName = "";
	Удален.Guid = NsgService.StringToGuid("6e7ecc70-bc5d-4609-a9cb-925a7286aa85");
	...
	Шаблон.GroupName = "";
	Шаблон.Guid = NsgService.StringToGuid("1fef36d2-1d2a-47c2-bdc4-0b3222abbfb3");
	...
	Проведен.GroupName = "";
	Проведен.Guid = NsgService.StringToGuid("db90bbe8-30a6-438c-bf1f-15402c1100a8");
	...
	Предопределенный.Guid = NsgService.StringToGuid("46e6a11c-05f8-402f-845c-084326a6ecbd");
	...
	Visible = true;
	Guid = NsgService.StringToGuid("7a058b3c-05c6-4537-a7bb-5fd8848712ce");
	DefaultSortingName = "";
	...
	GroupName = "Сервис";
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("7a058b3c-05c6-4537-a7bb-5fd8848712ce"));
            if (obj == null)
