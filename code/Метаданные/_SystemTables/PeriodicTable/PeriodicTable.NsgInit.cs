...
namespace Авто.Метаданные._SystemTables
{
    ...
    [NsgTypeName("NsgDataTable", Guid = "899e7fcd-7320-4fbb-9a1a-bf2713c5cf70")]
    public partial class PeriodicTable : NsgSoft.DataObjects.NsgDataTable
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("899e7fcd-7320-4fbb-9a1a-bf2713c5cf70"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("b5642be0-1404-42ff-b6dd-fb62c8be14fe");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("23df4acb-5696-41ea-8dc6-0cb959a6872a");
	...
	Владелец.GroupName = "";
	Владелец.Guid = NsgService.StringToGuid("4c6e0eef-389b-44a5-a649-ac054a799da8");
	...
	Дата.GroupName = "";
	Дата.Guid = NsgService.StringToGuid("e9761799-4d40-4f48-8ef2-11d9c8f52966");
	...
	Значение.GroupName = "";
	Значение.Guid = NsgService.StringToGuid("4b152d92-296c-4467-adcd-eb783a993f2d");
	...
	Индекс.GroupName = "";
	Индекс.Guid = NsgService.StringToGuid("fb04102a-86c5-454f-b7b6-1ef2a2ab91b0");
	...
	Name = "PeriodicTable";
	Visible = true;
	Guid = NsgService.StringToGuid("899e7fcd-7320-4fbb-9a1a-bf2713c5cf70");
	DefaultSortingName = "";
