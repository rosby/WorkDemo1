...
namespace Авто.Метаданные.Автосервис
{
    ...
    [NsgTypeName("NsgDataDocument", Guid = "35d2d595-ed3d-45a9-966a-00a0da023ea1")]
    public partial class РасходнаяНакладная : NsgSoft.DataObjects.NsgDataDocument
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("35d2d595-ed3d-45a9-966a-00a0da023ea1"));
            if (obj == null)
	...
	Идентификатор.Guid = NsgService.StringToGuid("13d447a5-0214-4bd8-acf5-63e1898e8aa8");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("8d65ec96-a433-4183-a3a6-aecc80748a6e");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("e53435c5-5ec7-488b-9a0d-129b5e5e84bb");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("bc6605fd-2332-4e19-98f8-9e1b89a5ba0a");
	...
	НомерДокумента.Guid = NsgService.StringToGuid("745e08ff-82d4-4f05-8a7d-d2303118cb2e");
	...
	ДатаДокумента.Guid = NsgService.StringToGuid("64a13736-721a-4676-bdf5-b61ebf5ec809");
	...
	Индекс.GroupName = "";
	Индекс.Guid = NsgService.StringToGuid("43e5c269-83ff-484e-86ad-c50f5aeff6bf");
	...
	ДокументОснование.Guid = NsgService.StringToGuid("3008da96-f2bf-469c-9098-6b892f6e3eed");
	...
	Комментарий.Guid = NsgService.StringToGuid("fcd716c4-0e44-45ef-9420-de7362067c16");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("2045d4a8-f3d7-445d-aec5-76c286653f38");
	...
	Контрагенты.Guid = NsgService.StringToGuid("810302b1-765d-4bfd-8164-b2915dad3849");
	...
	ФормаЭлемента.Guid = NsgService.StringToGuid("4f303f9e-85d2-4e6a-bba3-f51e0cc180fe");
	...
	Таблица.GroupName = "";
	Таблица.Guid = NsgService.StringToGuid("10ac3b98-96e1-43a0-9101-5586b2966b73");
	...
	SlaveDocuments = new List<string>(new string[]{"Сервис.ОбщийЖурнал", "Сервис.СервернаяЗадача", "Автосервис.ПриходнаНакладная", "Автосервис.РасходнаяНакладная"});
	...
	Visible = true;
	Guid = NsgService.StringToGuid("35d2d595-ed3d-45a9-966a-00a0da023ea1");
	DefaultSortingName = "";
