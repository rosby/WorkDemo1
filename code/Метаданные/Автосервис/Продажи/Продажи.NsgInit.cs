...
namespace Авто.Метаданные.Автосервис
{
    ...
    [NsgTypeName("NsgReportObject", Guid = "24b44761-2ce6-4fbb-b7fc-753747fb44bf")]
    public partial class Продажи : NsgSoft.DataObjects.NsgReportObject
    {
        #region Данные
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("24b44761-2ce6-4fbb-b7fc-753747fb44bf"));
            if (obj == null)
                obj = new Продажи();
	...
	Идентификатор.Guid = NsgService.StringToGuid("a9547a7c-9a4b-467d-ac89-b7f2da7a9cb1");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("7edbfdbf-527d-44fb-8a88-2e9a5bd0c518");
			...
			#region создание Авто.Метаданные.Автосервис.ПродажиФорма Форма
			{  
	...
	Форма.FormClassName = "Авто.Метаданные.Автосервис.ПродажиФорма";
	...
	Форма.GroupName = "";
	Форма.Guid = NsgService.StringToGuid("f5848924-9296-4abd-9cf8-b1bc755eb145");
	
				if (!ObjectList.Contains("Форма"))
                    ObjectList.Add(Форма);
			}
			#endregion //создание Авто.Метаданные.Автосервис.ПродажиФорма Форма
	...
	Name = "Продажи";
	Visible = true;
	Guid = NsgService.StringToGuid("24b44761-2ce6-4fbb-b7fc-753747fb44bf");
	DefaultSortingName = "";
