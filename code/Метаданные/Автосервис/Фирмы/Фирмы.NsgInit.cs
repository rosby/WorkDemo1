...
namespace Авто.Метаданные.Автосервис
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "8eb26341-0ac6-4097-a90e-e13a3ebd83c5")]
    public partial class Фирмы : NsgSoft.DataObjects.NsgDataDictionary
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("8eb26341-0ac6-4097-a90e-e13a3ebd83c5"));
            if (obj == null)
                obj = new Фирмы();
            return obj as Фирмы;
        }
	...
	Идентификатор.Guid = NsgService.StringToGuid("ed401842-c49c-49f1-9776-df99d8c37b4f");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("1d1876b1-bc55-444f-8c9b-bbb729d51e2f");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("36346987-b448-4fd3-9baf-5939365a5d93");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("bbf86a88-6e35-43de-bb7b-db04e3c44fd4");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("9b3ae7a3-04e6-4a76-b119-d431ae122306");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("740542c6-5bfd-4ecf-a1c2-c383ce9758d9");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("606370d4-631b-4911-836e-dce0a0f01069");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("f5ca7037-a4a3-4d87-9c63-33ad91ce1f1b");
	...
	Наименование.Guid = NsgService.StringToGuid("49a6c34e-3117-4da9-9f49-1303fcc1d435");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("c25951f5-8e85-4505-b9f2-b6ea2d3af70f");
	...
	Name = "Фирмы";
	Visible = true;
	Guid = NsgService.StringToGuid("8eb26341-0ac6-4097-a90e-e13a3ebd83c5");
	DefaultSortingName = "";
