...
namespace Авто.Метаданные.Автосервис
{
    ...
    public partial class Долги : NsgSoft.DataObjects.NsgReportObject
    {
        #region Данные
	...
	Автоинкремент.Guid = NsgService.StringToGuid("b3d8539c-73fa-49bd-accc-c29e2a880107");
			...
			#region создание Авто.Метаданные.Автосервис.ДолгиФорма Форма
			{  
	...
	Форма.FormClassName = "Авто.Метаданные.Автосервис.ДолгиФорма";
	...
	Форма.Guid = NsgService.StringToGuid("c62503df-0c1a-4bd9-a3de-6bbb14c4f601");
			...
			#endregion //создание Авто.Метаданные.Автосервис.ДолгиФорма Форма
			
			#region создание _SystemTables.АвтосервисДолгиТаблица Таблица
			{  
	...
	Таблица.ReferentName = "АвтосервисДолгиТаблица";
	Таблица.OwnerName = "";
	...
	Таблица.GroupName = "";
	Таблица.Guid = NsgService.StringToGuid("a34919b0-fb12-4ee1-b3fc-18c0c5b163d1");
	
				if (!ObjectList.Contains("Таблица"))
                    ObjectList.Add(Таблица);
			}
			#endregion //создание _SystemTables.АвтосервисДолгиТаблица Таблица
	...
	GroupName = "Автосервис";
        ...
        public _SystemTables.АвтосервисДолгиТаблица Таблица
        {
            get
            {
				 NsgDataTableReference __Таблица = ObjectList["Таблица"] as NsgDataTableReference;
                 return (_SystemTables.АвтосервисДолгиТаблица)__Таблица.Referent;
            }
            set
            {
                NsgDataTableReference __Таблица = ObjectList["Таблица"] as NsgDataTableReference;
        ...
        private Долги[] convertArray(NsgMultipleObject[] array)
        {
            Долги[] res = new Долги[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual Долги[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual Долги[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual Долги[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual Долги[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new Долги(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
			...
			public new Долги Value
            {
                get
                {
                    return (Долги)base.Value;
                }
                set
                {
                    base.Value = value;
