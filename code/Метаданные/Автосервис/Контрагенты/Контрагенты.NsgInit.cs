...
namespace Авто.Метаданные.Автосервис
{
    ...
    [NsgTypeName("NsgDataDictionary", Guid = "64ecdb99-d49c-480f-bf91-7ea780b3cd7f")]
    public partial class Контрагенты : NsgSoft.DataObjects.NsgDataDictionary
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("64ecdb99-d49c-480f-bf91-7ea780b3cd7f"));
            if (obj == null)
                obj = new Контрагенты();
	...
	Идентификатор.Guid = NsgService.StringToGuid("c8fa7842-03f0-43a9-bc81-ffbf5412f20f");
	...
	Автоинкремент.Guid = NsgService.StringToGuid("c2378ed9-5fba-4fcc-b05b-7e1d026b176a");
	...
	ЭтоГруппа.GroupName = "";
	ЭтоГруппа.Guid = NsgService.StringToGuid("ab28eacb-3680-4f61-a15d-2061519746a5");
	...
	ИдентификаторРодителя.Guid = NsgService.StringToGuid("67658df7-5d07-48cd-b804-5913b485d7a3");
	...
	Уровень.GroupName = "";
	Уровень.Guid = NsgService.StringToGuid("5f8fe1d0-eb92-4963-8888-ad1c4bf19c2d");
	...
	ПрефиксКода.Guid = NsgService.StringToGuid("3e149aaf-5cfb-4da6-9eed-a73e345dce6e");
	...
	НомерКода.GroupName = "";
	НомерКода.Guid = NsgService.StringToGuid("c00c2a65-13d8-4670-93ed-19c4c183818a");
	...
	Код.GroupName = "";
	Код.Guid = NsgService.StringToGuid("f97ed88b-fa85-47b4-8d11-888fa6ba6a3d");
	...
	Наименование.Guid = NsgService.StringToGuid("2b81fe52-993b-4957-87a6-ee4d1aa862f0");
	...
	СостояниеДокумента.Guid = NsgService.StringToGuid("98367111-c0df-47e8-8a16-dcdda063158e");
	...
	Name = "Контрагенты";
	Visible = true;
	Guid = NsgService.StringToGuid("64ecdb99-d49c-480f-bf91-7ea780b3cd7f");
	DefaultSortingName = "";
