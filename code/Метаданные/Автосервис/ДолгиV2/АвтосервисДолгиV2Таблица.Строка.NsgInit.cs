...
{
    public partial class АвтосервисДолгиV2Таблица
{
    [NsgTypeName("NsgDataTableRow", Guid = "5d3a5078-b210-4fea-b18a-4f1c080777d3")]
    public partial class Строка : NsgSoft.DataObjects.NsgDataTableRow
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("5d3a5078-b210-4fea-b18a-4f1c080777d3"));
            if (obj == null)
                obj = new Строка();
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "АвтосервисДолгиV2Таблица";
        ...
        [NsgReferentsFilterAttribute("Автосервис.ДолгиV2")]
