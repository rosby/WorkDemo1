...

{
    ...
    public partial class ПриходнаНакладнаяФормаЭлемента:NsgSoft.Forms.NsgMultipleObjectElementForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ПриходнаНакладнаяФормаЭлемента));
            ...
            this.nsgEdit.Location = new System.Drawing.Point(972, 1);
            ...
            this.nsgClose.Location = new System.Drawing.Point(1088, 1);
            ...
            this.nsgToolStrip2.Size = new System.Drawing.Size(1167, 28);
            ...
            this.nsgAll.Location = new System.Drawing.Point(702, 1);
            ...
            this.nsgHandling.Location = new System.Drawing.Point(797, 1);
            ...
            this.nsgSave.Location = new System.Drawing.Point(881, 1);
            ...
            this.panelButtons.Size = new System.Drawing.Size(1167, 30);
            ...
            this.nsgButtonBasic.Location = new System.Drawing.Point(702, 1);
            ...
            this.Comment.FullName = "Автосервис.ПриходнаНакладная.Идентификатор";
            ...
            this.Comment.Size = new System.Drawing.Size(1167, 23);
        ...
        "Visible"};
            ...
            this.nsgIGrid1.Location = new System.Drawing.Point(100, 271);
            ...
            this.nsgIGrid1.Size = new System.Drawing.Size(891, 288);
            ...
            this.vmoТаблица.FullName = "_SystemTables.АвтосервисПриходнаНакладнаяТаблица.Владелец";
            // 
            // vmoТаблица
            // 
            nsgObjectDescriptor1.ConfigurationName = "Авто";
            nsgObjectDescriptor1.FullName = "_SystemTables.АвтосервисПриходнаНакладнаяТаблица.Владелец";
            nsgObjectDescriptor1.MetaDataName = "Метаданные";
            nsgMasterDetailBinding1.DetailField = nsgObjectDescriptor1;
            nsgObjectDescriptor2.FullName = "Автосервис.ПриходнаНакладная.Таблица";
            ...
            this.Номенклатура.NSGType = typeof(Авто.Метаданные.Автосервис.Номенклатура);
            this.Номенклатура.PropertyType = typeof(Авто.Метаданные.Автосервис.Номенклатура);
            ...
            this.Таблица.NSGType = typeof(Авто.Метаданные._SystemTables.АвтосервисПриходнаНакладнаяТаблица);
            this.Таблица.PropertyType = typeof(Авто.Метаданные._SystemTables.АвтосервисПриходнаНакладнаяТаблица);
            ...
            this.Контрагент.NSGType = typeof(Авто.Метаданные.Автосервис.Контрагенты);
            this.Контрагент.PropertyType = typeof(Авто.Метаданные.Автосервис.Контрагенты);
