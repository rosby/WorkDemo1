...
namespace Авто.Метаданные._SystemTables
{
    ...
    [NsgTypeName("NsgDataTable", Guid = "6381fefe-b329-482f-9961-f6c948525b5a")]
    public partial class АвтосервисОстаткиНакопления_1 : NsgSoft.DataObjects.NsgDataTable
    {
        #region Данные
        ...
        /// Создание объекта
        /// </summary>
        protected АвтосервисОстаткиНакопления_1()
            : base()
        {
        }
        ...
        /// </summary>
        protected АвтосервисОстаткиНакопления_1(NsgObject obj)
            : base(obj)
        {
        }
        ...
        public static АвтосервисОстаткиНакопления_1 Новый()
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("6381fefe-b329-482f-9961-f6c948525b5a"));
            if (obj == null)
                obj = new АвтосервисОстаткиНакопления_1();
            return obj as АвтосервисОстаткиНакопления_1;
        }
	...
	Автоинкремент.Guid = NsgService.StringToGuid("dbadcd65-d7e3-4299-b60a-ed6b0ecda424");
	...
	ДатаДокумента.Guid = NsgService.StringToGuid("a10eeba2-42b5-455d-b7f0-1b34e3cc2301");
	...
	Name = "АвтосервисОстаткиНакопления_1";
	Visible = true;
	Guid = NsgService.StringToGuid("6381fefe-b329-482f-9961-f6c948525b5a");
	DefaultSortingName = "";
	...
	TableName = "Ав_tab_AvtoservisOstatki2";
	Presentation = new NsgSoft.DataObjects.NsgLanguageString(new System.String[]{"(Default)"},
		 new System.Object[]{""});
	Description = "Автосервис остатки накопления_1";
	...
	GroupName = "_SystemTables";
        ...
        {
            return "_SystemTables.АвтосервисОстаткиНакопления_1";
        }
        ...
        /// </summary>
        public new АвтосервисОстаткиНакопления_1.Строка NewRow()
        {
            return newRow(null) as АвтосервисОстаткиНакопления_1.Строка;
        }
        ...
        {
            if (row == null)
                row = new АвтосервисОстаткиНакопления_1.Строка(this);
            return base.newRow(row) as АвтосервисОстаткиНакопления_1.Строка;
        }

        /// <summary>
        /// Добавить новую строку в таблицу путем копирования переданной строки
        /// </summary>
        public АвтосервисОстаткиНакопления_1.Строка NewRow(АвтосервисОстаткиНакопления_1.Строка inRow)
        {
            АвтосервисОстаткиНакопления_1.Строка row = inRow.Clone as АвтосервисОстаткиНакопления_1.Строка;
            return base.newRow(row) as АвтосервисОстаткиНакопления_1.Строка;
        }
        ...
        /// </summary>
        public new АвтосервисОстаткиНакопления_1.Строка GetRow(int rowNumber)
        {
            return base.GetRow(rowNumber) as АвтосервисОстаткиНакопления_1.Строка;
        }

        /// <summary>
        /// Возвращает новую строку таблицы, но в саму таблицу ее не включает (эталонная строка)
        /// </summary>
        public new АвтосервисОстаткиНакопления_1.Строка GetEtalonRow()
        {
            АвтосервисОстаткиНакопления_1.Строка row = new АвтосервисОстаткиНакопления_1.Строка(this);
            row.MetaData = MetaData;
            return row;
        }

        private АвтосервисОстаткиНакопления_1.Строка[] convertRowsArray(NsgDataTableRow[] array)
        {
            АвтосервисОстаткиНакопления_1.Строка[] res = new АвтосервисОстаткиНакопления_1.Строка[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new АвтосервисОстаткиНакопления_1.Строка FindRowByTag(object Tag)
        {
            return base.FindRowByTag(Tag) as АвтосервисОстаткиНакопления_1.Строка;
        }
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new АвтосервисОстаткиНакопления_1.Строка[] FindRowsByTag(object Tag)
        {
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new АвтосервисОстаткиНакопления_1.Строка FindRow(NsgCompare compare)
        {
            return base.FindRow(compare) as АвтосервисОстаткиНакопления_1.Строка;
        }
        ...
        /// <returns>Найденные строки.</returns>
        public new АвтосервисОстаткиНакопления_1.Строка FindRow(string inName, object inValue)
        {
            return base.FindRow(inName, inValue) as АвтосервисОстаткиНакопления_1.Строка;
        }
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new АвтосервисОстаткиНакопления_1.Строка FindRow(NsgDataFixedFields inName, object inValue)
        {
            return base.FindRow(inName, inValue) as АвтосервисОстаткиНакопления_1.Строка;
        }
        ...
        /// <param name="compare">Критерии поиска.</param>
        /// <returns>Найденные строки.</returns>
        public new АвтосервисОстаткиНакопления_1.Строка[] FindRows(NsgCompare compare)
        {
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new АвтосервисОстаткиНакопления_1.Строка[] FindRows(string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение поля.</param>
        /// <returns>Найденные строки.</returns>
        public new АвтосервисОстаткиНакопления_1.Строка[] FindRows(NsgDataFixedFields inName, object inValue)
        {
            return convertRowsArray(base.FindRows(inName, inValue));
        }
        ...
        /// </summary>
        public  NsgVirtualCursor<АвтосервисОстаткиНакопления_1> GetNewVirtualCursor()
        {
            return base.GetNewVirtualCursor<АвтосервисОстаткиНакопления_1>();
        }

        /// <summary>
        /// Получить все строки таблицы с учетом наложенного фильтра. Для получения всех сьтрок без учета фильтра используется свойство AllRows
        /// </summary>
        public new АвтосервисОстаткиНакопления_1.Строка[] Rows
        {
            get
            {
        ...
        /// </summary>
        public new АвтосервисОстаткиНакопления_1.Строка[] AllRows
        {
            get
            {
        ...
        /// <returns>Найденные строки.</returns>
        public new АвтосервисОстаткиНакопления_1.Строка GetRow(Guid inID)
        {
            return base.GetRow(inID) as АвтосервисОстаткиНакопления_1.Строка;
        }
        #endregion
        ...
        private АвтосервисОстаткиНакопления_1[] convertArray(NsgMultipleObject[] array)
        {
            АвтосервисОстаткиНакопления_1[] res = new АвтосервисОстаткиНакопления_1[array.Length];
            array.CopyTo(res, 0);
            return res;
        }
        ...
        public new virtual АвтосервисОстаткиНакопления_1[] FindAll(NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual АвтосервисОстаткиНакопления_1[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgCompare compare)
        {
        ...
        /// <returns>Список найденных объектов.</returns>
        public new virtual АвтосервисОстаткиНакопления_1[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, string inName, object inValue)
        {
        ...
        /// <param name="inValue">Значение для поиска. Условие поиска - полное совпадение.</param>
        /// <returns>Список найденных объектов.</returns>
        public new virtual АвтосервисОстаткиНакопления_1[] FindAll(ref int count, Int64 row_start, NsgSorting sorting, NsgDataFixedFields inName,
            object inValue)
        {
            return convertArray(base.FindAll(ref count, row_start, sorting, inName, inValue));
        }
        ...
        public override NsgObject CloneObject
        {
            get
            {
                return new АвтосервисОстаткиНакопления_1(this as NsgObject);
            }
        }
        ...
        public new class ColumnDescriptor : NsgSoft.Forms.NsgColumnDescriptor
        {
            public ColumnDescriptor()
                : base()
            {
                base.NSGType = typeof(АвтосервисОстаткиНакопления_1);
            }
			...
			public new АвтосервисОстаткиНакопления_1 Value
            {
                get
                {
                    return (АвтосервисОстаткиНакопления_1)base.Value;
                }
                set
                {
                    base.Value = value;
