...
{
    public partial class АвтосервисОстаткиНакопления_1
{
    [NsgTypeName("NsgDataTableRow", Guid = "6381fefe-b329-482f-9961-f6c948525b5a")]
    public partial class Строка : NsgSoft.DataObjects.NsgDataTableRow
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("6381fefe-b329-482f-9961-f6c948525b5a"));
            if (obj == null)
                obj = new Строка();
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "АвтосервисОстаткиНакопления_1";
