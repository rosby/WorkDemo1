...
{
    public partial class АвтосервисОстаткиНакопления
{
    [NsgTypeName("NsgDataTableRow", Guid = "435ac49c-755f-4f46-bb41-f662252ecca6")]
    public partial class Строка : NsgSoft.DataObjects.NsgDataTableRow
    {
        ...
        {
            NsgBaseObject obj = CreateByGuid(NsgService.StringToGuid("435ac49c-755f-4f46-bb41-f662252ecca6"));
            if (obj == null)
                obj = new Строка();
        ...
        public override NsgMultipleObjectDescriptor Descriptor
        {
            get
            {
                if (descriptor == null)
                {
                    ...
                    descriptor.Name = "АвтосервисОстаткиНакопления";
