...
namespace Авто.Метаданные.Автосервис
{
	...
	Автоинкремент.Guid = NsgService.StringToGuid("7edbfdbf-527d-44fb-8a88-2e9a5bd0c518");
			...
			#region создание Авто.Метаданные.Автосервис.ПродажиОтчетФорма Форма
			{  
	...
	Форма.FormClassName = "Авто.Метаданные.Автосервис.ПродажиОтчетФорма";
	...
	Форма.Guid = NsgService.StringToGuid("f5848924-9296-4abd-9cf8-b1bc755eb145");
			...
			#endregion //создание Авто.Метаданные.Автосервис.ПродажиОтчетФорма Форма
